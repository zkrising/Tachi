import { Game, Playtypes, ImportTypes, FileUploadImportTypes, AnyChartDocument, IRImportTypes, APIImportTypes } from "./types";
...
export declare const defaultScoreRatingAlgorithm: {
    iidx: {
        SP: string;
        DP: string;
    };
...
export declare const defaultSessionRatingAlgorithm: {
    iidx: {
        SP: string;
        DP: string;
    };
