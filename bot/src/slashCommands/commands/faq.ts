...
For more info on why this is a fundamental limitation of ${ServerConfig.name}, check [the documentation](https://docs.bokutachi.xyz/en/latest/user/score-oddities/#deduplication-false-positives-all-games).`,
...
${ServerConfig.name} is an Open Source project. Feel free to read our [contribution guide](https://docs.bokutachi.xyz/en/latest/contributing/), or just generally ask for stuff to help out with!`,
...
Read more about this [here](https://docs.bokutachi.xyz/en/latest/user/pbs-scores/)`,
...
Read more about them [here](https://docs.bokutachi.xyz/en/latest/user/filter-directives/)`,
