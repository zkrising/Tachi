...
For more info on why this is a fundamental limitation of ${ServerConfig.name}, check [the documentation](https://docs.bokutachi.xyz/user/score-oddities/#deduplication-false-positives-all-games).`,
...
Read more about this [here](https://docs.bokutachi.xyz/user/pbs-scores/)`,
...
Read more about them [here](https://docs.bokutachi.xyz/user/filter-directives/)`,
