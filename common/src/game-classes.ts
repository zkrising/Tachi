...
const __internalIIDXDans: ClassData = {
    kaiden: {
        display: "皆伝",
        mouseover: "Kaiden",
        index: 18,
...
const __internalSDVXDans: ClassData = {
    inf: {
        display: "LV.∞",
        mouseover: "Inf. Dan",
        index: 12,
...
const __internalGitadoraColours: ClassData = {
    rainbow: {
        display: "虹",
        mouseover: "Rainbow",
        index: 16,
...
const __internalGenocideDans: ClassData = {
    overjoy: {
        display: "(^^)",
        mouseover: "Overjoy",
        index: 22,
...
const __internalStellaDans: ClassData = {
    st11: {
        display: "st11",
...
export const gameClassValues: GameClasses = {
    iidx: {
        SP: {
...
export const defaultGameClasses = {
    iidx: {
        SP: "dan",
        DP: "dan",
    },
